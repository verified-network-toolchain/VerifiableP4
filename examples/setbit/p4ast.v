...
Definition Increment := DeclControl NoInfo
    ...
    [(MkParameter false InOut (TypBit 8%N) None
              ...
              (StatAssignment
                   (MkExpression NoInfo
                        (ExpName
                         ...
                         (LInstance ["var"])) (TypBit 8%N) InOut)
                   (MkExpression NoInfo
                        (ExpBinaryOp Plus
                             (MkExpression NoInfo
                                  (ExpName
                             ...
                             (MkExpression NoInfo
                                  ...
                                  (TypBit 8%N) Directionless)) (TypBit 8%N)
...
Definition MyIngress := DeclControl NoInfo
    ...
    [(DeclVariable NoInfo (TypBit 8%N) {| stags := NoInfo; str := "x" |}
          (Some
           (MkExpression NoInfo
                (ExpCast (TypBit 8%N)
                     (MkExpression NoInfo
     ...
     (DeclInstantiation NoInfo
          (TypSpecializedType
               (TypTypeName {| stags := NoInfo; str := "Increment" |}) nil)
          nil {| stags := NoInfo; str := "incr" |} nil)]
    (BlockCons
         (MkStatement NoInfo
              (StatMethodCall
                   (MkExpression NoInfo
                        ...
                        (TypFunction
                         (MkFunctionType nil
                              [(MkParameter false InOut (TypBit 8%N) 
                                    None {| stags := NoInfo; str := "var" |})]
                              FunControl TypVoid)) Directionless) nil
                   [(Some
                     (MkExpression NoInfo
                          (ExpName
                           (BareName {| stags := NoInfo; str := "x" |})
                           (LInstance ["x"])) (TypBit 8%N) InOut))]) StmUnit)
         (BlockCons
              (MkStatement NoInfo
                   (StatAssignment
                        (MkExpression NoInfo

        ...
        (MEM [(["ds_md"], ValBaseStruct
                 [("clear_window", P4Bit 16 (fst timer));
                  ...
                  ("win_3", P4_bf2_win_md_t_clear 2 cf if' clear_index_1
                        [hash_index_1; hash_index_2; hash_index_3]);
                  ("win_4", P4_bf2_win_md_t_clear 3 cf if' clear_index_1
                        [hash_index_1; hash_index_2; hash_index_3])])]
        (EXT [])))))%arg_ret_assr.
  ...
  WITH (* p *),
    ...
    WITH (key : Val) (tstamp : Z) (cf : filter num_frames num_rows num_slots),
      ...
      POST
        ...
        (MEM []
        (EXT [filter_repr p 18 panes rows (filter_clear cf (Z.odd (tstamp/2097152)) (hashes key))]))).
...
Proof.
  ...
  unfold filter_clear, ConFilter.filter_clear.
  unfold proj1_sig.
  fold new_timer.

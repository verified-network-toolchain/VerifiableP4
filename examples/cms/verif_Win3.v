...
Require Import ProD3.examples.cms.verif_Row31.
Require Import ProD3.examples.cms.verif_Row32.
Require Import ProD3.examples.cms.verif_Row33.
Require Import ProD3.examples.cms.verif_Row34.
Require Import ProD3.examples.cms.verif_Row35.
...
Definition p := ["pipe"; "ingress"; "cm2_ds"; "win_3"].
...
Proof.
  ...
  { entailer. }
  { auto. }
  step_call verif_Row34.Row_noop_case_body.
  { entailer. }
  { auto. }
  step_call verif_Row35.Row_noop_case_body.
  { entailer. }
  { auto. }
...
Proof.
  ...
  { entailer. }
  { auto. }
  step_call verif_Row34.Row_insert_case_body.
  { entailer. }
  { auto. }
  step_call verif_Row35.Row_insert_case_body.
  { entailer. }
  { auto. }
  step_call tbl_merge_rows_1_undef_body.
  { entailer.
...
Ltac pose_row_query_bound r i :=
  ...
  { entailer. }
  { auto. }
  step_call verif_Row34.Row_query_case_body.
  { entailer. }
  { auto. }
  step_call verif_Row35.Row_query_case_body.
  { entailer. }
  { auto. }
...
Proof.
  ...
  { entailer. }
  { auto. }
  step_call verif_Row34.Row_clear_case_body.
  { entailer. }
  { auto. }
  step_call verif_Row35.Row_clear_case_body.
  { entailer. }
  { auto. }
  step_call tbl_merge_rows_1_body.
  { entailer. }

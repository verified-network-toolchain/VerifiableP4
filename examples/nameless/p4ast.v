...
Definition c := DeclControl NoInfo {| stags := NoInfo; str := "c" |} nil
    [(MkParameter false InOut
          (TypTypeName {| stags := NoInfo; str := "headers" |}) None
          {| stags := NoInfo; str := "hdr" |})] nil
    [(DeclAction NoInfo {| stags := NoInfo; str := "hello" |} nil nil
          (BlockCons
               (MkStatement NoInfo
                    (StatAssignment
                         (MkExpression NoInfo
                         ...
                         (MkExpression NoInfo
                              ...
                              (TypBit 8%N) Directionless)) StmUnit)
               (BlockEmpty NoInfo)));
     (DeclTable NoInfo {| stags := NoInfo; str := "t" |}
          [(MkTableKey NoInfo
                (MkExpression NoInfo
                     (ExpExpressionMember
                          (MkExpression NoInfo
          ...
          [(MkTableActionRef NoInfo
                (MkTablePreActionRef
                     (BareName {| stags := NoInfo; str := "hello" |}) nil)
                   ...
                   (MkExpression NoInfo
                        ...
                        (TypFunction
                         (MkFunctionType nil nil FunTable
                              (TypTypeName
                               {| stags := NoInfo; str := "apply_result_t" |})))
                         ...
                         (StatAssignment
                              ...
                              (MkExpression NoInfo
                                   (ExpName
                                    (BareName
                                     {| stags := NoInfo; str := "newByte" |})
                                    (LInstance ["do_forward"; "newByte"]))
                                   (TypBit 8%N) In)) StmUnit)
                    (BlockEmpty NoInfo))));
...
Definition prog := Program
    [decl'1; packet_in; packet_out; verify'check'toSignal; NoAction; decl'2;
     ...
     V1Switch; egressSpec_t; myHeader_t; metadata; headers; MyParser; c;

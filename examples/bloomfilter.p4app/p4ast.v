...
Definition custom_metadata_t := DeclStruct NoInfo
    {| stags := NoInfo; str := "custom_metadata_t" |}
    [(MkDeclarationField NoInfo (TypBit 32)
          {| stags := NoInfo; str := "index0" |});
     (MkDeclarationField NoInfo (TypBit 32)
          {| stags := NoInfo; str := "index1" |});
     (MkDeclarationField NoInfo (TypBit 32)
          {| stags := NoInfo; str := "index2" |});
     (MkDeclarationField NoInfo (TypBit 1)
          {| stags := NoInfo; str := "member0" |});
     (MkDeclarationField NoInfo (TypBit 1)
          {| stags := NoInfo; str := "member1" |});
     (MkDeclarationField NoInfo (TypBit 1)
          {| stags := NoInfo; str := "member2" |})].

Definition headers := DeclStruct NoInfo
    {| stags := NoInfo; str := "headers" |}
    [(MkDeclarationField NoInfo
          (TypHeader
           [(MkFieldType {| stags := NoInfo; str := "rw" |} (TypBit 8));
            (MkFieldType {| stags := NoInfo; str := "data" |} (TypBit 16))])
...
Definition MyParser := DeclParser NoInfo
    ...
    [(MkParameter false Directionless
     ...
     (MkParameter false InOut
          (TypTypeName
           (BareName {| stags := NoInfo; str := "custom_metadata_t" |})) 
          None {| stags := NoInfo; str := "meta" |});
     (MkParameter false InOut
          (TypTypeName
           (BareName {| stags := NoInfo; str := "standard_metadata_t" |}))
    ...
    [(MkParserState NoInfo {| stags := NoInfo; str := "start" |}
          [(MkStatement NoInfo
                (StatMethodCall
                     ...
                     [(TypHeader
                       [(MkFieldType {| stags := NoInfo; str := "rw" |}
                             (TypBit 8));
                        (MkFieldType {| stags := NoInfo; str := "data" |}
                             (TypBit 16))])]
                     [(Some
                       (MkExpression NoInfo
                            (ExpExpressionMember
...
Definition bloom0 := DeclInstantiation NoInfo
    (TypSpecializedType
         (TypTypeName (BareName {| stags := NoInfo; str := "register" |}))
         [(TypBit 1)])
    [(MkExpression NoInfo
          (ExpCast (TypBit 32)
               (MkExpression NoInfo
          ...
          (TypBit 32) Directionless)] {| stags := NoInfo; str := "bloom0" |}
    None.
          ...
          (ExpCast (TypBit 32)
               (MkExpression NoInfo
                    (ExpInt
                     {| itags := NoInfo; value := 1024;
                        width_signed := None |}) TypInteger Directionless))
          (TypBit 32) Directionless)] {| stags := NoInfo; str := "bloom1" |}
    None.
          ...
          (ExpCast (TypBit 32)
               (MkExpression NoInfo
                    (ExpInt
                     {| itags := NoInfo; value := 1024;
                        width_signed := None |}) TypInteger Directionless))
          (TypBit 32) Directionless)] {| stags := NoInfo; str := "bloom2" |}
    None.
                   ...
                   (MkExpression NoInfo
                        ...
                        (TypFunction
                         (MkFunctionType
                              ...
                              FunExtern TypVoid)) Directionless)
                   [(TypBit 32); (TypBit 10);
                    (TypList [(TypBit 16); (TypBit 3)]); (TypBit 10)]
                   [(Some
                     (MkExpression NoInfo
                          (ExpExpressionMember
                               (MkExpression NoInfo
                     ...
                     (MkExpression NoInfo
                          (ExpInt
                           {| itags := NoInfo; value := 0;
                              width_signed := (Some ( 10, false )) |})
                          (TypBit 10) Directionless));
                    (Some
                     (MkExpression NoInfo
                          (ExpList
                           [(MkExpression NoInfo
                          ...
                          (TypList [(TypBit 16); (TypBit 3)]) Directionless));
                    (Some
                     (MkExpression NoInfo
                          (ExpInt
                           {| itags := NoInfo; value := 1023;
                              width_signed := (Some ( 10, false )) |})
                          (TypBit 10) Directionless))]) StmUnit)
         (BlockCons
              (MkStatement NoInfo
                   (StatMethodCall
                        (MkExpression NoInfo
                             ...
                             (TypFunction
                              (MkFunctionType
                                   ...
                                   FunExtern TypVoid)) Directionless)
                        [(TypBit 32); (TypBit 10);
                         (TypList [(TypBit 16); (TypBit 5)]); (TypBit 10)]
                        [(Some
                          (MkExpression NoInfo
                               (ExpExpressionMember
                                    (MkExpression NoInfo
                                 ...
                                 (MkExpression NoInfo
                                      (ExpInt
                                       {| itags := NoInfo; value := 5;
                                          width_signed := (Some ( 5, false )) |})
                                      (TypBit 5) Directionless)])
                               (TypList [(TypBit 16); (TypBit 5)])
                               Directionless));
                         (Some
                          (MkExpression NoInfo
                               (ExpInt
...
Definition Query := DeclControl NoInfo {| stags := NoInfo; str := "Query" |}
    nil
    [(MkParameter false InOut
          (TypTypeName (BareName {| stags := NoInfo; str := "headers" |}))
          None {| stags := NoInfo; str := "hdr" |});
          ...
          (TypParser
           (MkControlType nil
                [(MkParameter false Directionless
                 ...
                 (MkParameter false Out
                      (TypStruct
                       [(MkFieldType {| stags := NoInfo; str := "myHeader" |}
                             (TypHeader
                              [(MkFieldType
                                    {| stags := NoInfo; str := "rw" |}
                                    (TypBit 8));
                 ...
                 (MkParameter false InOut
                      (TypStruct
                       [(MkFieldType {| stags := NoInfo; str := "index0" |}
                             (TypBit 32));
                        (MkFieldType {| stags := NoInfo; str := "index1" |}
                             (TypBit 32));
                        (MkFieldType {| stags := NoInfo; str := "index2" |}
                             (TypBit 32));
                        (MkFieldType {| stags := NoInfo; str := "member0" |}
                             (TypBit 1));
                        (MkFieldType {| stags := NoInfo; str := "member1" |}
                             (TypBit 1));
                        (MkFieldType {| stags := NoInfo; str := "member2" |}
                             (TypBit 1))]) None
                      {| stags := NoInfo; str := "meta" |});
                 (MkParameter false InOut
                      (TypStruct

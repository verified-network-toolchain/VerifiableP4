               ...
               (MkStatement NoInfo
                    (StatMethodCall
                         (MkExpression NoInfo
                              ...
                              (TypFunction
                               (MkFunctionType nil
                                    [(MkParameter false Out (TypBit 4) 
                                          None
                                          {| stags := NoInfo;
                                             str := "result" |});
                        ...
                        (MkExpression NoInfo
                             (ExpCast (TypSet (TypBit 1))
                                  (MkExpression NoInfo
                                       ...
                                       Directionless)) (TypSet (TypBit 1))
                             Directionless)) (TypSet (TypSet (TypBit 1))))]
                 (MkTableActionRef NoInfo
                      (MkTablePreActionRef
                           (BareName
                                         ...
                                         (MkExpression NoInfo
                                              (ExpInt
                                               {| itags := NoInfo;
                                                  ...
                                                  width_signed := None |})
                                              TypInteger Directionless))
                                    (TypBit 1) Directionless) )) TypBool
                        Directionless)
                   (MkStatement NoInfo
                        (StatBlock
                         (BlockCons

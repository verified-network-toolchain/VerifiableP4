                                    ...
                                    (ExpBinaryOp Plus
                                         ( (MkExpression NoInfo
                                           ...
                                           (MkExpression NoInfo
                                                ...
                                                (TypBit 4%N) Directionless) ))
                                    (TypBit 4%N) Directionless))
                              (LInstance ["do_forward"; "x"])) StmUnit)
                    (BlockCons
                         (MkStatement NoInfo
                              (StatMethodCall
                                   (MkExpression NoInfo
                                        ...
                                        (ExpName
                                         (BareName
                                          {| stags := NoInfo;
                                             str := "drop" |})
                                         (LInstance ["drop"]))
                                        (TypAction nil nil) Directionless)
                                   nil nil) StmUnit) (BlockEmpty NoInfo)))
                ...
                [(MkParameter false Directionless
                 ...
                 (MkParameter false InOut
                      (TypStruct
                       [( {| stags := NoInfo; str := "counter" |},
                          (TypBit 4%N) );
                        ( {| stags := NoInfo; str := "x" |}, (TypBit 4%N) );
                        ( {| stags := NoInfo; str := "y" |}, (TypBit 4%N) )])
                      None {| stags := NoInfo; str := "meta" |});
                 (MkParameter false InOut
                      (TypStruct
                       [( {| stags := NoInfo; str := "ingress_port" |},

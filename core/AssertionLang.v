...
Proof.
  ...
  - split.
    + destruct a as [a_loc a_v]. simpl in *. destruct loc; destruct a_loc; only 1-3 : sfirstorder.
      rewrite loc_to_val_update_val_by_loc_different. { hauto use: path_equivb_symm unfold: is_true, andb, negb. }
      sfirstorder.
...
Proof.
  ...
  - split.
    + destruct a as [a_loc a_v]. simpl in *. destruct loc; destruct loc'; destruct a_loc; only 1-7 : sfirstorder.
      rewrite loc_to_val_update_val_by_loc_different.
...
Proof.
  ...
  - destruct a as [hd_loc hd_v]. simpl. destruct hd_loc; only 1 : hauto lq: on.
    ...
    + split.
      * simpl. rewrite loc_to_val_update_val_by_loc_different. { hauto use: path_equivb_symm unfold: negb, is_true. }
        sfirstorder.
      * apply IHa; [hauto b: on | sfirstorder].
Qed.
